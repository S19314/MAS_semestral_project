...
-- Last modification date: 2021-06-20 23:33:43.66
...
CREATE TABLE CustomerConversation (
    IdCustomerConversation int  NOT NULL,
    MarkServiceQuality int  NOT NULL,
    StartDateTime datetime  NOT NULL,
    EndDateTime datetime  NOT NULL,
    ConversationDurationInSeconds int  NOT NULL,
    Client_IdOsoba int  NOT NULL,
    Employe_IdOsoba int  NOT NULL,
    CONSTRAINT CustomerConversation_pk PRIMARY KEY  (IdCustomerConversation)
);
...
-- Reference: PlaceWork_Person (table: PlaceWork)
ALTER TABLE PlaceWork ADD CONSTRAINT PlaceWork_Person
    FOREIGN KEY (Employee_IdPerson)
    REFERENCES Person (IdOsoba);
