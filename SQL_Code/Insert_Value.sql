...
INSERT INTO Person(IdOsoba, RelationWithCompany, FirstName, SecondName, FirstLastPlaceWork, InternshipDaysInCurentHotel, HourRate, LastDateChangeRate, WorkShift)
VALUES(2, 'Employee', 'Szyza', 'Kolin', 'Samsung Company', 100, 13.5, GETDATE(), 'day-night');
